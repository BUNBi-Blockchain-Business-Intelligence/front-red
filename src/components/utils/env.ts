...
export const landingPageUrl = 'https://bunbi.com.mx'
...
// SEO settings
export const seoSitemapLastmod = getEnvAsDate('SEO_SITEMAP_LASTMOD')
export const seoSitemapPageSize = getEnvAsNumber('SEO_SITEMAP_PAGE_SIZE') || DEFAULT_PAGE_SIZE
